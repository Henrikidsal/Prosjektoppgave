...
def Master_problem_pyomo(data, thermal_gens, renewable_gens, time_periods, gen_startup_categories, gen_pwl_points):
    ...
    while not convergence and iteration < max_iterations:
        ...
        #Solves sub problem
        subproblem_model, dual_values, sub_cost = subproblem(data=data, master_solution=master_solution, thermal_gens=thermal_gens, renewable_gens=renewable_gens, time_periods=time_periods, gen_pwl_points=gen_pwl_points)
        m = subproblem_model
        #Set UB
        ...
        generate_benders_cut(master, data, thermal_gens, renewable_gens, time_periods, gen_pwl_points, m, dual_values, sub_cost, master_solution)
